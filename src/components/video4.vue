  ...
  <div style="width:100%;height:100%;z-index:1;">
    ...
    <el-row class="borderDiv" style="width:100%;height:92%">
      <el-col :span="22" class="el-wrapper" style="height:100%;overflow:auto;">
        <img src="/static/img/n2-word.svg" style="margin-top:-10%" />
      ...
      <el-col :span="2">
        ...
        <el-row class="tab">
          <el-col :span="16" :offset="4">
            <img src="../assets/icon/n4h.svg" />
          </el-col>
        </el-row>
        <el-row class="tab">
          <el-col :span="22" :offset="2">
            <router-link to="/answer4"><img src="/static/img/checkAnswer.PNG" width="80%"/></router-link>
          </el-col>
        </el-row>
      </el-col>

    </el-row>
    <el-col :span="8" :offset="8" v-show="isShowLogin" style="position:absolute;left:0px;top:30%;z-index:3">
      <login @close="hidenLogin"></login>
    </el-col>
    ...
    data() {
      return {
        playerOptions: {
          ...
          sources: [{
            type: "video/mp4", // 类型
            src: '/static/video/n4.mp4' // url地址
          }],
          poster: '/static/video/n4-bg.PNG', // 封面地址
